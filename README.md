...
A hash, published now, that lets me prove later that I already had a working implementation as of this
...
No algorithm, constants, or source code are in this repository.
See [`PROOF_2026-07-30_seedkey_algo_sha256.md`](./PROOF_2026-07-30_seedkey_algo_sha256.md).
...
authenticity if I share details in the future). Publishing only the hash accomplishes this.
